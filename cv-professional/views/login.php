        ...
        <div class="card-body">
            <form method="post">
                <div class="form-group mb-3">
                    echo $userMailErr;?></small>
                    <input type="email" name="logmail" class="f<small class="text-danger"><?php echo $error; ?></small>
                    <small class="text-danger"><?php orm-control form-control-sm rounded-0 shadow-none px-1" placeholder="E-mail">
                </div>
                <div class="form-group mb-3">
